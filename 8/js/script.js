...
/* harmony import */ var _prize_animation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./prize-animation.js */ "./source/js/modules/prize-animation.js");
/* harmony import */ var _delay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./delay */ "./source/js/modules/delay.js");
...
class FullPageScroll {
  ...
  async changePageDisplay() {
    ...
    if (currentScreen && currentScreen.id === `story` && this.screenElements[this.activeScreen].id === `prizes`) {
      ...
      await Object(_delay__WEBPACK_IMPORTED_MODULE_2__["delay"])(this.ANIMATION_TIMEOUT);
      this.toogleDisplay();
      animationBackground.classList.remove(`active`);
      await Object(_prize_animation_js__WEBPACK_IMPORTED_MODULE_1__["startPrizesAnimation"])();
    } else {
      this.toogleDisplay();
    }
  }
...
/*!**********************************************!*\
  !*** ./source/js/modules/prize-animation.js ***!
  \**********************************************/
/*! exports provided: startPrizesAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startPrizesAnimation", function() { return startPrizesAnimation; });
/* harmony import */ var _delay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./delay */ "./source/js/modules/delay.js");


async function startPrizesAnimation() {
  ...
  await Object(_delay__WEBPACK_IMPORTED_MODULE_0__["delay"])(4000);
...
/* harmony import */ var _modules_delay_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/delay.js */ "./source/js/modules/delay.js");
/* harmony import */ var _modules_prize_animation_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/prize-animation.js */ "./source/js/modules/prize-animation.js");
...
const animationTopTitle = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_12__["default"](`.intro__title`, 400, `active-text`, `transform`);
const animationTopDate = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_12__["default"](`.intro__date`, 400, `active-text`, `transform`);

window.addEventListener(`load`, async () => {
  if (window.location.hash.slice(1) === `prizes`) {
    await Object(_modules_prize_animation_js__WEBPACK_IMPORTED_MODULE_10__["startPrizesAnimation"])();
  }
  document.body.classList.add(`loaded`);
  await Object(_modules_delay_js__WEBPACK_IMPORTED_MODULE_9__["delay"])(300);
  animationTopTitle.runAnimation();
  await Object(_modules_delay_js__WEBPACK_IMPORTED_MODULE_9__["delay"])(400);
