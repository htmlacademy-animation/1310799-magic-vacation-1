...
const animationTopTitle = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_10__["default"](`.intro__title`, 400, `active-text`, `transform`);
const animationTopDate = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_10__["default"](`.intro__date`, 400, `active-text`, `transform`);
